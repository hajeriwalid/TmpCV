...
def create_map_data():
    ...
    customer_locations = pd.DataFrame({
        'city': ['Charenton-le-Pont', 'Jersey City', 'Bray', 'London', 'Seoul', 'Madrid', 'Barcelona', 'Rome', 'Geneva',
                 ...
                 'Lomé'],
        'lat': [48.826, 40.721, 53.202, 53.3498, 51.5074, 37.5665, 40.4168, 41.3851, 41.9028, 46.2022,
                ...
                6.1305],
        'lon': [2.435, -74.041, -6.105, -6.2603, -0.1278, 126.9780, -3.7038, 2.1734, 12.4964, 6.1490,
